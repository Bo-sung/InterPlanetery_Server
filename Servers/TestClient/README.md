...
### 1. 연결 메뉴 (미접속 상태)
- **1. Connect to server** - 서버 접속 (메뉴 기본값: 127.0.0.1:7777 — **주의**: `BaseServer`는
  로컬 실행 시 포트 9000(Docker는 11021)에서 대기하므로, 접속 시 포트를 직접 9000으로 입력하세요.
  7777은 과거 채팅 프로토타입의 유물입니다.)
- **0. Exit** - 프로그램 종료
