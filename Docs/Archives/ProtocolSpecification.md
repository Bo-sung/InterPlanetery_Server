> **⚠️ ARCHIVED — 폐기된 문서 (2인 채팅 프로토타입, 포트 7777, opcode 1001–2999)**
> 현재 서버 프로토콜(포트 9000, opcode 10000–30100)은
> [`Docs/클라이언트_구현_가이드.md`](../클라이언트_구현_가이드.md)를 참고하세요. 과거 참고용으로만 보존합니다.
